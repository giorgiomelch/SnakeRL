...
import model
import enviroment_no_visual
import enviroment_visual
...
class Agent:
    def __init__(self, lr, gamma, max_memory, batch_size, model_units=256, 
        ...
        self.dqnetwork = model.QNetwork(lr=lr, gamma=gamma, units=model_units)
...
class Agent_DoubleDQN(Agent):
    def __init__(self, lr, gamma, max_memory, batch_size, model_units=256, 
        ...
        super().__init__(lr, gamma, max_memory, batch_size, model_units, 
                         eps_greedy, file_name_model, visual)
        self.dqnetwork = model.DoubleQNetwork(lr=lr, gamma=gamma, units=model_units)
...
class Agent_PER(Agent):
    def __init__(self, lr, gamma, max_memory, batch_size, model_units=256, 
        ...
        self.dqnetwork = model.PER_QNetwork(lr=lr, gamma=gamma, units=model_units)
...
class Agent_DDQN_PER(Agent_DoubleDQN):
    def __init__(self, lr, gamma, max_memory, batch_size, model_units=256, 
                 eps_greedy=True, file_name_model="model_DDQNP_ER.keras", visual=False):
        super().__init__(lr, gamma, max_memory, batch_size, model_units, 
                         eps_greedy, file_name_model, visual)
        self.memory = replay_buffer.PrioritizedReplayBuffer(max_size=max_memory, zeta=0.6)
        self.dqnetwork = model.DDQN_PER_QNetwork(lr=lr, gamma=gamma, units=model_units)
